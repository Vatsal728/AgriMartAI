      ...
      <div className="flex w-full max-w-[540px] flex-col gap-10">
        <div className="flex flex-col items-center gap-6 text-center">
          ...
          <div className="flex flex-col gap-2">
            <h1 className="font-heading text-3xl font-bold text-slate-900">{t("onboarding.language.title")}</h1>
            <p className="text-base text-text-muted">{t("onboarding.language.subtitle")}</p>
          </div>
        </div>
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="flex items-center justify-between border-t border-slate-200 pt-4 text-xs text-text-faint">
            ...
            <div className="flex gap-4">
              <Link href="/help-center">{t("common.helpCenter")}</Link>
